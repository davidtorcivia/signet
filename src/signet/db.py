...
STOPWORDS = frozenset(
    "a an and are as at about be but by can did do does for from had has have how i if in "
    "into is it its me my of on or said say tell that the their them then there these they "
    "this to was were what when where which who whom why will with would you your".split()
)
